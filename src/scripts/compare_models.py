...
def run_comparison(model1_dir, model2_dir, model1_type="gemma", model2_type="gemma", num_samples=10, output_file="comparison_results.md"):
    ...
    # --- Model 1 ---
    print(f"\nEvaluating Model 1: {model1_dir} (Type: {model1_type})...")
    pipeline1 = InferencePipeline(model_dir=model1_dir, model_type=model1_type)
    ...
    # --- Model 2 ---
    print(f"\nEvaluating Model 2: {model2_dir} (Type: {model2_type})...")
    pipeline2 = InferencePipeline(model_dir=model2_dir, model_type=model2_type)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model1_type", type=str, default="gemma", help="Type of first model ('gemma' or 'codet5')")
    parser.add_argument("--model2", type=str, default="base", help="Path to second model (or 'base')")
    parser.add_argument("--model2_type", type=str, default="gemma", help="Type of second model ('gemma' or 'codet5')")
    ...
    run_comparison(m1, m2, args.model1_type, args.model2_type, args.num_samples, args.output)
